...
public class HoaDonTiec extends JFrame{
	...
	public HoaDonTiec(String title,String NgayH,String MaHd)
	{
		super(title);
	...
	private void HienThiThongTin() {
		...
		try{
			...
			Double ST=0.0;
			int i=1;
			String Sql = "select SanPham.TenSP, Soluong,DonGia, DonGia*Soluong,NhanVien.TenNV from SanPham,HoaDonTiec,NhanVien,ChiTietHoaDonTiec where SanPham.MaSP=ChiTietHoaDonTiec.MaSP and HoaDonTiec.MaHD=ChiTietHoaDonTiec.MaHD and HoaDonTiec.MaNV=NhanVien.MaNV and HoaDonTiec.MaHD=?";
			PreparedStatement prepare = conn.prepareStatement(Sql);
			
		
			prepare.setString(1, maH);
			lbl8.setText(maH);
			lblls.setText(NgayH);
